...
| Phase 3 touch chain | Yes, in shared scaffold `98f7c57`; proof slice `0a3b26f` | PARTIAL / local-pass | `8.D1-8.D4` open | SD6/SD7 open | Yes: expanded control screenshots; no physical mutation proof | Physical tap/drag state-link evidence; drag automation currently `operator-pass pending` |
| Phase 4 demo control panel | Yes, in shared scaffold `98f7c57`; proof slice `564d0c0` | PARTIAL / local+simulator-pass | `8.E1-8.E3` should be checked; `8.E4` remains open | SD13/SD14/SD15 and RPB-52 checked; SD8/SD12 open | Yes: control panel, all-state, main-before screenshots | Settings-entry physical tap proof and cabin macro interaction recording |
...
- Keep Phase 3 rows open until touch state-link evidence exists.
