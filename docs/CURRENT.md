...
- UI 改动前准备工件：`docs/grill-tournament/uiue-r1-interaction-integrity-matrix-2026-06-27.md` 和 `docs/grill-tournament/uiue-r2b-layout-spacing-checker-spec-2026-06-27.md`。前者只记录 R1 交互矩阵与 gaps，后者只定义 R2b 结构门 schema / proof split；二者均为 `local/docs-only`，不授权 UI 实现，不关闭 `8.C2`，不替代 L3。
