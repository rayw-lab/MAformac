...
> ⭐ **当前 baseline 指针（2026-07-11，D-142）**：`active_baseline_v6` = `docs/roadmap-2026-07-11-v6-closure-baseline.md`（`decision_status=RATIFIED`，`baseline_activation=PENDING_CASCADE`）；`docs/roadmap-2026-07-07-macos-closure-baseline.md` 标为 `historical_superseded`，其 Line B 执行细账与五门定义仍作为 v6 一手引用。层级保持：`CLAUDE.md` 定宪法、`decisions.md` 记决策、`CURRENT.md` 仅 router、OpenSpec 记行为契约、run-dir 记 receipt。
