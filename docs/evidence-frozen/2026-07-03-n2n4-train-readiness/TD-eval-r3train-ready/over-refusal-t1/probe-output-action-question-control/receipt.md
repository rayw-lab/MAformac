...
proof_class: local
output_dir: /Users/wanglei/Projects/agent-tmux-stack-research/runs/2026-07-03-n2n4-train-readiness/TD-eval-r3train-ready/over-refusal-t1/probe-output-action-question-control
...
```json
{
  ...
  "per_case": [
    {
      "case_id": "r3-t1-action-question-seat-001",
      "expected_tool_names": [
    ...
    {
      "case_id": "r3-t1-action-question-seat-002",
      "expected_tool_names": [
    ...
    {
      "case_id": "r3-t1-action-question-window-001",
      "expected_tool_names": [
        "open_window"
      ],
      "all_expected_tools_seen_in_train": true,
    ...
    {
      "case_id": "r3-t1-action-question-window-002",
      "expected_tool_names": [
        "close_window"
      ],
      "all_expected_tools_seen_in_train": true,
    ...
    {
      "case_id": "r3-t1-action-question-door-001",
      "expected_tool_names": [
        "open_car_door"
      ],
      "all_expected_tools_seen_in_train": true,
    ...
    {
      "case_id": "r3-t1-action-question-door-002",
      "expected_tool_names": [
        "close_car_door"
      ],
      "all_expected_tools_seen_in_train": true,
    ...
    {
      "case_id": "r3-t1-action-question-light-001",
      "expected_tool_names": [
    ...
    {
      "case_id": "r3-t1-action-question-light-002",
      "expected_tool_names": [
    ...
    {
      "case_id": "r3-t1-action-question-screen-001",
      "expected_tool_names": [
    ...
    {
      "case_id": "r3-t1-action-question-screen-002",
      "expected_tool_names": [
    ...
    {
      "case_id": "r3-t1-action-question-volume-001",
      "expected_tool_names": [
        "raise_volume_little"
      ],
      "all_expected_tools_seen_in_train": true,
    ...
    {
      "case_id": "r3-t1-action-question-volume-002",
      "expected_tool_names": [
        "lower_volume_little"
      ],
      "all_expected_tools_seen_in_train": true,
    ...
    {
      "case_id": "r3-t1-action-question-wiper-001",
      "expected_tool_names": [
        "open_wiper"
      ],
      "all_expected_tools_seen_in_train": true,
    ...
    {
      "case_id": "r3-t1-action-question-wiper-002",
      "expected_tool_names": [
        "close_wiper"
      ],
      "all_expected_tools_seen_in_train": true,
    ...
    {
      "case_id": "r3-t1-action-question-sunroof-001",
      "expected_tool_names": [
        "open_sunroof"
      ],
      "all_expected_tools_seen_in_train": true,
    ...
    {
      "case_id": "r3-t1-action-question-sunroof-002",
      "expected_tool_names": [
        "close_sunroof"
      ],
      "all_expected_tools_seen_in_train": true,
    ...
    {
      "case_id": "r3-t1-action-question-sunshade-001",
      "expected_tool_names": [
        "open_sunshade"
      ],
      "all_expected_tools_seen_in_train": true,
    ...
    {
      "case_id": "r3-t1-action-question-sunshade-002",
      "expected_tool_names": [
        "close_sunshade"
      ],
      "all_expected_tools_seen_in_train": true,
