...
public final class DemoVehicleStateStore {
    ...
    public static func defaultCells() -> [DemoVehicleStateCell] {
        [
            ...
            DemoVehicleStateCell(key: "ambient.power", actualValue: "off"),
            DemoVehicleStateCell(key: "seat.heat_level[副驾]", actualValue: "0"),
            ...
            DemoVehicleStateCell(key: "door.car_door", actualValue: "closed"),
