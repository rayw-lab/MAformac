...
- [x] Create proposal, design, dialogue-state-semantic-consumption spec, tasks, and carrier metadata.
  - Output: greenfield W7 change tree.
  - Acceptance: no W8 lifecycle owner or W5c/W9/V2 boundary is absorbed.
- [x] Expand M16-001/003/004/005/006 into complete Requirement and Scenario trace.
...
- [x] Run change strict and all strict validation.
  - Acceptance: rc0; red is HOLD and receives no self-invented repair.

## P1 — Typed bounded window schema

- [x] Freeze the versioned, finite, bounded, read-only envelope behavior.
...
- [x] Define paired/unpaired reason set and bounded retention behavior.
...
- [x] Define W8 fact to W7 field-effect mapping.
...
- [x] Define independent focus/readback validity and clear/retain/audit-only effects.
...
- [x] Define read-only consumer envelope and mutation allowlist.
...
- [x] Define future verify-dialogue-state-source target, independent checker, exact suite, and deliberate negatives.
...
- [x] Define future official wiring and materialization receipt.
...
- [x] Define future verify-dialogue-state-consumption integration target, checker, exact suite, and deliberate negatives.
...
- [x] Keep roster/presence single-source rules explicit.
...
- [x] Record proof caps and excluded predecessors.
...
- [x] Run producer/independent audit with W8 boundary and Runner CRITICAL stopline.
  - Output: audit receipt.
  - Acceptance: producer and auditor are separate; any scope expansion requires a new risk key.
- [x] Keep future apply, coding, merge, gate materialization, registry reanchor, and package state flip as separate keys.
...
- [x] Write current-day pair receipt with pre-flip W7 plan SHA, carrier file SHA list, HEAD, strict rc, executor, time, and conventions SHA.
  - Acceptance: receipt is complete and independently hashable.
- [x] Flip W7 plan frontmatter to SUPERSEDED_BY_CARRIER after the pair receipt exists.
