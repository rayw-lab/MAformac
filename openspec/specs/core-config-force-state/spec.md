# core-config-force-state Specification

## Purpose
Define the main-owned Core config vocabulary, one physical debug/demo catalog, exact migration and digest semantics, and the single force-state write-owner boundary.
