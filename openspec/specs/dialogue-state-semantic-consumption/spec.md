# dialogue-state-semantic-consumption Specification

## Purpose
Define bounded, versioned DialogueState semantics that consume W8 lifecycle facts without owning lifecycle, while preserving independent focus/readback validity and fail-closed context restoration.
