...
## Purpose
Define the single-owner session lifecycle, cancellation fence, stable-checkpoint recovery, generation monotonicity, and evidence claim boundaries for the offline MAformac demonstration.
