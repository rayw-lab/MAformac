...
起手读:本文件 → **⭐`docs/srd-three-layer-intent-routing.md`(架构事实源,防失忆,必读第一)** → **`docs/research/INDEX.md`(调研/teardown 索引 + 应用机制;C3-C7 实装前查对应 adopt 指令)** → 最近 `docs/handoffs/` → `docs/c1-q1-q10-claude-oracle-grill-2026-06-19.md` + `docs/adr/0001-*` + `CONTEXT.md`(C1/C2 全料)→ `docs/cockpit-voice-fc-premortem-2026-06-18.md`(座舱原理 + demo 边界)。
